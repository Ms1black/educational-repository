...
QT_MOC_LITERAL(7, 77, 15), // "onHeaderClicked"
QT_MOC_LITERAL(8, 93, 12) // "logicalIndex"

    },
    "TableManager\0onEditSaveButtonClicked\0"
    "\0onDateChanged\0date\0onComboChanged\0"
    "text\0onHeaderClicked\0logicalIndex"
};
...
void TableManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->onHeaderClicked((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
